...
// -------------------------- Part I: Functions --------------------------------
	...
	Что означает this в функции?
		Вызывается в методе объекта.
		Указывает на объект из которого был вызван.

	Свойсва функции?
		.length
		.prototype

	Чтобы контролировать this:
	Методы: (Не прямой вызов)
		.call - передает значения
			someFunction.call(object, arguments)
		.apply - передает массив
			someFunction.apply(object, [arg1, arg2...])
...
// --------------------------- Part III: Closures -------------------------=----
	...
	Замыкание
		Замыкание - переменные видны внутри блока кода и только.
