let ImageCounter = function(props) {
    ...
    return (
        <div className = 'image-counter'>
            ...
            <img src = { './img/' + props.image} onClick = { props.onCount }/>
        </div>
       )
}
    ...
    render: function(){
        ...
        return (
            <div className = 'container'>
                <ImageCounter image = { this.props.image }
                              count    = { this.state.count }
                              onCount =  { this.handeClick } />
        ...
        return (
            <div>
                { this.props.heroes.map((hero) => {
                    return <Hero title={ hero.title } subtitle={ hero.subtitle } image={ hero.image } key={ hero.id }/>
                    })}
            </div>
        )
    }
...
// que: There are FOUR instanceof HERO? ------------> YES/NO?
